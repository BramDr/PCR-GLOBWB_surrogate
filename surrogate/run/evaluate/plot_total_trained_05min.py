...
for submask in submasks:
    ...
    df_file = pl.Path("{}/output_ts.csv".format(train_trainset_dir))
    ...
    df_file = pl.Path("{}/output_cdf.csv".format(train_trainset_dir))
    pred_plot_df = pd.read_csv(df_file, index_col=0)
    pred_plot_df["type"] = "Trained"
    ...
    df_file = pl.Path("{}/output_sp.csv".format(train_trainset_dir))
    pred_plot_df = pd.read_csv(df_file, index_col=0)
    pred_plot_df["type"] = "Trained"
