...
dir_out = pl.Path("./saves/global_30min/transform")
datasets = ["input", "output", "upstream_input", "upstream_output", "upstream_details"]

subsets = [dir.stem for dir in transform_dir.iterdir() if dir.is_dir() if "train_" in dir.stem or "hyper" in dir.stem]
