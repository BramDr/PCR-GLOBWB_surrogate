...
for submask in submasks:
    ...
    submask_out = pl.Path("{}/{}/setup".format(dir_out, submask))
    ...
    for dataset in datasets:
        ...
        dataset_dir = pl.Path("{}/{}".format(trainset_dir, dataset))
        ...
        for index in features.index:
            ...
            setup_subset_dir = pl.Path("{}/{}/{}/{}".format(setup_submask_dir, source, section, option))
            
            meta_file = pl.Path("{}/{}_meta.pkl".format(setup_subset_dir, variable))
            meta = load_meta(file=meta_file)
            
            transformer_file = pl.Path("{}/{}_transformer.pkl".format(dataset_dir, feature))
