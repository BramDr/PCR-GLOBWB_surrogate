...
for dataset in datasets:
    ...
    subset_dir = pl.Path("{}/../{}/cells_training/{}".format(save_dir, train_subset, dataset))
    meta_files = [file for file in subset_dir.rglob("*_meta.pkl")]
    ...
    for feature in features:
        ...
        ts_file = pl.Path("{}/{}_{}_ts.csv".format(dir_out, dataset, feature_name))
        ts_file.parent.mkdir(parents=True, exist_ok=True)
        cdf_file = pl.Path("{}/{}_{}_cdf.csv".format(dir_out, dataset, feature_name))
        cdf_file.parent.mkdir(parents=True, exist_ok=True)
        sp_file = pl.Path("{}/{}_{}_sp.csv".format(dir_out, dataset, feature_name))
        ...
        for sequence in sequences:
            ...
            for subset in subsets:
                ...
                subset_dir = pl.Path("{}/{}/{}".format(sequence_dir, subset, dataset))
