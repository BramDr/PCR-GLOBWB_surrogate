...
for submask in submasks:
    ...
    for trainset in trainsets:
        ...
        subset_dirs = [pl.Path("{}/cells_training".format(trainset_dir)),
                       pl.Path("{}/cells_validation_spatial".format(trainset_dir)),
                       pl.Path("{}/cells_validation_temporal".format(trainset_dir)),
                       pl.Path("{}/cells_validation_spatiotemporal".format(trainset_dir))]
