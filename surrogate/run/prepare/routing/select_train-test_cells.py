...
out_dir = pl.Path("./saves/train-test")
seed = 19920223
...
for resolution in resolutions:
    ...
    for routing_type, details in routing_details.items():
        ...
        subset_nsamples_routing = int(subset_nsamples_base * (routing_cells.index.size / cells.index.size))
        ...
        for discharge_bin in reversed(routing_cells['bin'].unique()):
            ...
            subset_nsamples = int(subset_nsamples_routing * bin_fraction)
