...
for subset in subsets:
    ...
    corrected_file = pl.Path("{}/array_corrected.npy".format(subset_out))
    ...
    corrector_file = pl.Path("{}/correcter.pkl".format(save_subset_dir))
    with open(corrector_file, 'rb') as file:
        corrector = pickle.load(file)
        
    y_corr, _ = corrector.correct(array=y_pred)

    #np.save(file = corrected_file, arr = y_corr)
