...
prepare_dir = pl.Path("../../prepare/landsurface/saves/train-test2/mulres")
out_dir = pl.Path("./saves/train-test2/mulres")
datasets = ["input", "output"]

trainsets = [dir.stem for dir in prepare_dir.iterdir() if dir.is_dir()]

trainset = trainsets[0]
for trainset in trainsets:
    print("\tTrainset: {}".format(trainset))
    
    prepare_trainset_dir = pl.Path("{}/{}".format(prepare_dir, trainset))
